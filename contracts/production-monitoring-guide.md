...
graph TD
    ...
    subgraph "Tập hợp & Giám sát (AWS CloudWatch / Prometheus)"
        ...
        DB -->|Read/Write Capacity| Collector
...
*   **DynamoDB Read/Write Throttling (Đơn vị: Số lần)**:
    *   *Mục đích*: Đảm bảo DynamoDB (lưu cache/idempotency) hoạt động mượt mà, không bị nghẽn do quá tải đọc/ghi.
